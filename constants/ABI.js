const dexabi = [
  {
    inputs: [
      { internalType: "address", name: "_nftProtocolToken", type: "address" },
    ...
    inputs: [
      {
        ...
        indexed: false,
        internalType: "struct NFTProtocolDEX.Component[]",
        name: "make",
        type: "tuple[]",
      },
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_feeBypassLow", type: "uint256" },
      { internalType: "uint256", name: "_feeBypassHigh", type: "uint256" },
    ],
    name: "vote",
    outputs: [],
    stateMutability: "nonpayable",
